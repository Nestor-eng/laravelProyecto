...
<div class="card" style="background-color: #420E09">
        ...
        <div class="col-12">
            ...
            <div class="float-right">
                ...
                <a class="btn btn-app" href="Medidas/create">
              ...
              <div class="card-body">
                <div id="example2_wrapper" class="table dt-responsive data-table dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable dtr-inline collapsed" role="grid" aria-describedby="example2_info">
                  ...
                  <tr role="row">
                      ...
                      <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Edad: activate to sort column descending">Pecho</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Teléfono: activate to sort column descending">Brazo</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Dirección: activate to sort column descending">Cintura</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Dirección: activate to sort column descending">Cadera</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Dirección: activate to sort column descending">Piernas</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Dirección: activate to sort column descending">Pantorrilla</th>
                      <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Dirección: activate to sort column descending">Porcentaje de grasa</th>
                  ...
                  <tr>
                      ...
                      <th rowspan="1" colspan="1" style="">Pecho</th>
                      <th rowspan="1" colspan="1" style="">Brazo</th>
                      <th rowspan="1" colspan="1" style="">Cintura</th>
                      <th rowspan="1" colspan="1" style="">Cadera</th>

                      <th rowspan="1" colspan="1" style="">Piernas</th>
                      <th rowspan="1" colspan="1" style="">Pantorrilla</th>
                      <th rowspan="1" colspan="1" style="">Porcentaje de grasa</th>
