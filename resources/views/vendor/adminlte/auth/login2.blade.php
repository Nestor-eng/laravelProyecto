                  ...
                  <div class="login-box">
                      ...
                      <div class="login-box-body">
                          <div class="login-logo">
                              ...
                              <a style="color:gray" href="{{ url('/home') }}"><b>Vikingos</b><a style="color:orange">Gym</a></a>
                          ...
                          <form action="{{ url('/login') }}" method="post">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-xs-4">
                                      <button href="/home" type="submit" class="btn btn-primary btn-block btn-flat">Entrar</button>
                                  </div><!-- /.col -->
                              </div>
                          </form>
